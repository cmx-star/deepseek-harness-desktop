...
const DSH_PKG_GITHUB_API: &str = "https://api.github.com/repos/cmx-star/deepseek-harness-pkg";
/// pkg 仓库 HTML 来源；`releases.atom` 走 github.com 而非 api.github.com，不受未认证限流约束。
const DSH_PKG_REPO: &str = "https://github.com/cmx-star/deepseek-harness-pkg";
